...
public class empleado {
	...
	//Cálculo del completmento por horas extras
	public float pagocomplemento(){
		return get_pagoextras()*get_numhorasextras();
	}
	
	//Cálculo y devolución de retención en función de casado y número de hijos
	...
	//Visualización información básica (NIF)
	public void println() {
		 System.out.printf("El NIF del empleado es: "+_NIF);
	}
	
	//Visualización de todos los datos del empleado
