...
public class aplicacionDVD {
	...
	public static void main(String[] args) {
        Scanner sc =new Scanner(System.in);
         ...
         //Te muestra por pantalla la informacion necesaria a introducir y despuÉs te pide que introduzcas
        ...
        System.out.println("Dinos el género");
        String genero = sc.nextLine();
        System.out.println("Duración");
        int duracion = sc.nextInt();
        
         //Llamada a la clase objeto para utilizar sus respectivos métodos
